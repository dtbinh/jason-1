...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
      DListNode node1 = this.next;
	  this.next = ((DList) myList).newNode(item, (DList) myList, this, node1);
	  node1.prev = this.next;
	  myList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
      DListNode node1 = this.prev;
	  this.prev = ((DList) myList).newNode(item, (DList) myList, node1, this);
	  node1.next = this.prev;
	  myList.size++;
  }
